...
namespace Damka.Classes
{
    class Constants
    {
        ...
        public static Color DARK_BROWN = System.Drawing.Color.FromArgb(66, 43, 34); // being set at Damka.cs - it's a duplicate
        public static Color LIGHT_BROWN = System.Drawing.Color.FromArgb(113, 82, 60); // the same
